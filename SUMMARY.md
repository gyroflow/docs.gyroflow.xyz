...
* [🎥 Supported Cameras](getting-started/supported-cameras/README.md)
  ...
  * [Flight controllers](getting-started/supported-cameras/flight-controllers.md)
...
* [🏗 Command Line Interface (CLI)](advanced-usage/command-line-interface-cli.md)
* [💻 Other](advanced-usage/other.md)
* [🔀 IMU Orientation & Rotation](advanced-usage/imu-orientation-and-rotation.md)
* [🎨 Color Differences](advanced-usage/color-differences.md)
* [🌀 Using External Gyro Sources](advanced-usage/using-external-gyro-sources/README.md)
  * [Action camera as a logger](advanced-usage/using-external-gyro-sources/action-camera-as-a-logger.md)
  * [Flight controller](advanced-usage/using-external-gyro-sources/flight-controller.md)
  * [ESP-gyrologger](advanced-usage/using-external-gyro-sources/esp-gyrologger.md)
  * [Flowshutter](advanced-usage/using-external-gyro-sources/flowshutter.md)
